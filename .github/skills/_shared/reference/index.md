...
| Ousia capability kernel、Zircon-style handle/object、kernel object manager、handle rights、channel/call、VMO/VMAR、driver framework、baseline-vs-reference | `kernel-baseline.md`          |
| `kernel`、OSTD、tooling、QEMU runner、host tooling、Cargo target、cfg 边界                                                                                      | `kernel-ostd-tooling.md`      |
| boot memory map、typed frame metadata、page allocator、kernel heap/slab、VMO/MemoryObject、VMAR/address space、VMA/page-table truth source                       | `memory-and-address-space.md` |
