...
| SAT 求解   | npm (旧版), opam   | NP-complete，可能无解或解不稳定          |
...
Ousia OS 的方案：直通路径（§4.6）作为一等设计，不靠 flag hack。
...
Ousia OS 的应对策略在 §4.6（三层分工）和 §3.7（Pager-backed Memory Object）中展开。
...
- [00-philosophy.md](./00-philosophy.md) — 设计总纲
- [02-package-cell.md](./02-package-cell.md) — 软件单元与依赖管理
- [05-data-and-filesystem.md](./05-data-and-filesystem.md) — 数据抽象与文件系统
- [07-compute-and-scheduling.md](./07-compute-and-scheduling.md) — 调度与异构硬件
