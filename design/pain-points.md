...
Ousia OS 的应对策略在 [04-data-and-filesystem.md](./core/04-data-and-filesystem.md)、[05-pager-and-memory.md](./core/05-pager-and-memory.md) 与 [08-communication-fabric.md](./core/08-communication-fabric.md) 中展开。
...
- [01-package-cell.md](./core/01-package-cell.md) — 软件单元与依赖管理
- [04-data-and-filesystem.md](./core/04-data-and-filesystem.md) — 数据抽象与文件系统
- [06-compute-and-scheduling.md](./core/06-compute-and-scheduling.md) — 调度与异构硬件