...
Ousia OS 的目标：异步是内核和服务的统一语义，不是用户态框架的补丁。
...
Ousia OS 的 Object Store：对象有稳定 ID，路径只是兼容投影。
...
Ousia OS 的应对策略在 [05-data-and-filesystem.md](./core/05-data-and-filesystem.md)、[06-pager-and-memory.md](./core/06-pager-and-memory.md) 与 [09-communication-fabric.md](./core/09-communication-fabric.md) 中展开。
...
- [02-package-cell.md](./core/02-package-cell.md) — 软件单元与依赖管理
- [05-data-and-filesystem.md](./core/05-data-and-filesystem.md) — 数据抽象与文件系统
- [07-compute-and-scheduling.md](./core/07-compute-and-scheduling.md) — 调度与异构硬件