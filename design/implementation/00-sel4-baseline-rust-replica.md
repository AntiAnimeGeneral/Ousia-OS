...
2. 继续收敛 CSpace descriptor facade、CNode window metadata 和 ObjectTable runtime CNode metadata，使 path lookup 和 CTE mutation 都消费已解析的 CNode-owned CTE location，而不是回退到全局 slot/window 事实。
