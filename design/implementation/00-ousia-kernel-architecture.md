...
4. 将 `AddressSpaceObject` 从固定 mapping slots 演进到可保留 metadata/page-table resources 的 exclusive VM reservation token，明确 page table owner、TLB shootdown、多核 locking 和 pager fault 边界。
