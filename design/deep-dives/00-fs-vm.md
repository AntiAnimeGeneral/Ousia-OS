...
>
> 主设计：[04-data-and-filesystem.md](../core/04-data-and-filesystem.md)（Object Store / Stream）, [05-pager-and-memory.md](../core/05-pager-and-memory.md)（Pager 细节）

## 讨论范围

本文是 [04-data-and-filesystem.md](../core/04-data-and-filesystem.md) 与 [05-pager-and-memory.md](../core/05-pager-and-memory.md) 的深挖材料，不是新的顶层规范。三部分：现代 FS 实践调研 → 目录树问题分析与 Ousia OS 方案 → VM 整合。若本文与主设计冲突，以 04/05 的契约为准。
...
> Pager 基本设计见 [05-pager-and-memory.md](../core/05-pager-and-memory.md)。此处只讨论 FS 特有的视角。
...
- [04-data-and-filesystem.md](../core/04-data-and-filesystem.md) — Object Store + Stream 顶层设计
- [05-pager-and-memory.md](../core/05-pager-and-memory.md) — Pager 细节（崩溃模型、缺页协议）
