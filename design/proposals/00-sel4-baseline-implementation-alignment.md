...
1. CNode object-owned CTE array：让 CNode object 拥有 CTE slot storage，把当前 CSpace CNode payload slot array 收敛为真实 typed backing slot storage，并收紧 lookup 返回值以减少 executor/CSpace 重复 lookup。
...
1. CNode object-owned CTE array：把当前 CSpace CNode payload slot array 迁到 CNode object slot storage，收紧 lookup 返回值，减少 executor/CSpace 重复 lookup。
