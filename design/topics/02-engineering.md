...
**驱动**：SDK 提供 Rust 安全绑定。闭源 C 驱动由 Driver Host 隔离边界保护，不进入内核地址空间。第一阶段优先稳定设备资源句柄、IOQueue/IOBuffer、事件和 reset/revoke 这些对象语义，不急于冻结巨大的设备 API 面。驱动对象模型和 ABI 边界归属 [07-driver-and-kernel.md](../core/07-driver-and-kernel.md)，本文只讨论工程化要求。
...
- [07-driver-and-kernel.md](../core/07-driver-and-kernel.md) — 驱动 SDK 和 ABI
