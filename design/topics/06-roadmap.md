...
需求编号来自 [requirements.md](../requirements.md)：R1 类 FUSE 接入，R2 目录挂载，R3 mmap，R4 zero-copy / low-copy，R5 同步/异步一等，R6 用户态服务热路径，R7 能力权限与按类别失效语义，R8 兼容域边界，R9 远程资源，R10 Package Cell 生命周期，R11 身份与密钥分层。
...
1. 消除隐式全局状态？ 2. 权限显式、可审计、可撤销或可失效？ 3. 支持异步、取消、背压？ 4. 前台交互被保护？ 5. 消除对 PATH/bashrc/profile 依赖？ 6. 强化 Package Cell 和 Capsule？ 7. 兼容性限制在边界上？ 8. 对异构硬件友好？ 9. 遵循 let-it-crash？ 10. 故障可测试、可观测、可诊断？
