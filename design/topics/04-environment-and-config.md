...
**核心立场：库 = Package Cell。** 库和应用是同一种东西的不同用途。库的安装、卸载、依赖管理、版本控制归属 [02-package-cell.md](../core/02-package-cell.md)。本文只约束运行环境如何引用这些 Cell。
...
- [02-package-cell.md](../core/02-package-cell.md) — Cell 的依赖声明
- [03-capsule-and-capability.md](../core/03-capsule-and-capability.md) — Capsule 沙盒边界
